...
(function (dirtyChai) {
  ...
  var properties = Object.getOwnPropertyNames(Assertion.prototype)
    ...
    .reduce(function(obj, descriptor) { obj.push(descriptor); return obj; }, []);
  ...
  // For all pure properties, convert it to a chainable
  properties
    .filter(function(property) { return property.name !== '_obj' && typeof property.get === 'function' && !Assertion.prototype.__methods.hasOwnProperty(property.name); })
    .forEach(function(property) {
